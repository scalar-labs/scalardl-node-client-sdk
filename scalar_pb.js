...
goog.exportSymbol('proto.rpc.AssetProofsRegistrationRequest', null, global);
 ...
 * @constructor
 */
proto.rpc.AssetProofsRegistrationRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.rpc.AssetProofsRegistrationRequest.repeatedFields_, null);
};
goog.inherits(proto.rpc.AssetProofsRegistrationRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.rpc.AssetProofsRegistrationRequest.displayName = 'proto.rpc.AssetProofsRegistrationRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.rpc.AssetProofsRegistrationRequest.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.rpc.AssetProofsRegistrationRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.rpc.AssetProofsRegistrationRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.rpc.AssetProofsRegistrationRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.rpc.AssetProofsRegistrationRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.rpc.AssetProofsRegistrationRequest}
 */
proto.rpc.AssetProofsRegistrationRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.rpc.AssetProofsRegistrationRequest;
  return proto.rpc.AssetProofsRegistrationRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.rpc.AssetProofsRegistrationRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.rpc.AssetProofsRegistrationRequest}
 */
proto.rpc.AssetProofsRegistrationRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.rpc.AssetProofsRegistrationRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.rpc.AssetProofsRegistrationRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.rpc.AssetProofsRegistrationRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.rpc.AssetProofsRegistrationRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 */
proto.rpc.AssetProofsRegistrationRequest.prototype.getProofsList = function() {
 ...
 * @return {!proto.rpc.AssetProofsRegistrationRequest} returns this
*/
proto.rpc.AssetProofsRegistrationRequest.prototype.setProofsList = function(value) {
 ...
 */
proto.rpc.AssetProofsRegistrationRequest.prototype.addProofs = function(opt_value, opt_index) {
 ...
 * @return {!proto.rpc.AssetProofsRegistrationRequest} returns this
 */
proto.rpc.AssetProofsRegistrationRequest.prototype.clearProofsList = function() {
